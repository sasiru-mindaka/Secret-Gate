...
<head>
    ...
    <style nonce="<?php echo htmlspecialchars($csp_nonce, ENT_QUOTES, 'UTF-8'); ?>">
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
        ...
        /* Feedback button/modal — matches index.php */
        .feedback-float-btn {
            position: fixed;
            bottom: 22px;
            right: 22px;
...
(function () {
    ...
    // USER FEEDBACK – avoid blocking alerts
    ...
    // LOADING STATE – prevent double submits
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // MODAL DISMISS – support cancel, overlay, and escape
        ...
        // SECURE SUBMIT – validate and protect feedback
        $('feedbackModalSend')?.addEventListener('click', async function () {
            ...
            try {
                ...
                if (data && data.success) {
                    ...
                    errorEl.textContent = (data && data.error) ? data.error : 'Something went wrong, please try again.';
                }
            } catch (err) {
                console.error(err);
