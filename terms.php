    ...
    <div class="app-container">
        ...
        <article class="glass-card">
            ...
            <section class="policy-section">
                ...
                <p>By accessing or using the <strong>SecretGate</strong> platform (<a href="https://secretgate.site">secretgate.site</a>), you agree to be bound by these Terms and Conditions. If you do not agree to these terms, you must refrain from using our services immediately.</p>
            </section>
            ...
            <section class="policy-section">
                ...
                <p>If you receive a message that violates these terms or infringes upon your rights, please use the built-in report feature or contact administration through the feedback tool on <!-- Add your domain here --><a href="https://secretgate.site">secretgate.site</a>
