...
<head>
    ...
    <title>Privacy Policy - Secret Gate</title>
    ...
    <div class="app-container">
        ...
        <article class="glass-card">
            <header class="policy-head">
                <div class="view-label">Zero-Knowledge Architecture</div>
            ...
            <section class="policy-section">
                ...
                <p>At <strong>SecretGate</strong>, privacy is not just a policy—it is built directly into our application's core architecture. SecretGate operates on a Zero-Knowledge paradigm designed to protect user identity and content confidentiality at every layer.</p>
                <div class="highlight-box"><strong>Key Guarantee:</strong> Messages sent via SecretGate are client-side encrypted before transmission. Neither system administrators, server hosts, nor third parties can read your raw messages.</div>
            </section>

            <section class="policy-section">
                <h2>2. Data Collection Policy</h2>
                <p>We believe in extreme data minimization. We do not collect personal identifiers unless explicitly necessary for system operation.</p>
                <ul>
                    <li><strong>No Account Required:</strong> Senders do not need to register, provide email addresses, phone numbers, or social media identities to send messages.</li>
                    <li><strong>No Personal Profiles:</strong> We do not construct user profiles, behavior tracking logs, or demographic databases.</li>
                    <li><strong>Minimal Security Logging:</strong> To mitigate automated spam and cyber abuse, we maintain temporary security logs containing anonymized (hashed) IP addresses and basic browser user-agent strings for rate-limiting purposes only.</li>
                </ul>
            </section>

            <section class="policy-section">
                <h2>3. Message Encryption &amp; Storage</h2>
                <p>SecretGate utilizes end-to-end client-side encryption mechanisms (RSA-OAEP combined with AES-256-GCM authentication tags):</p>
                <ul>
                    <li><strong>Client-Side Encryption:</strong> All message contents are encrypted inside the sender's web browser prior to being dispatched across the network.</li>
                    <li><strong>Zero-Knowledge Storage:</strong> Database tables store only unintelligible ciphertext strings. Raw plaintext messages never touch our database or disk storage.</li>
                    <li><strong>Decryption Control:</strong> Only the recipient holding the corresponding private key on their authorized device can decrypt and render the message text.</li>
                </ul>
            </section>

            <section class="policy-section">
                <h2>4. Cookies &amp; Local Storage</h2>
                <p>SecretGate does not use persistent tracking cookies, cross-site targeting scripts, or third-party analytics cookies.</p>
                <ul>
                    <li><strong>Essential Session Storage:</strong> Temporary browser session storage and CSRF verification tokens are utilized strictly to protect forms against cross-site request forgery attacks.</li>
                    <li><strong>Local Preferences:</strong> Encryption key pairs and user UI state may be saved in your browser's local storage (LocalStorage) solely for application functioning.</li>
                </ul>
            </section>

            <section class="policy-section">
                <h2>5. Third-Party Infrastructure</h2>
                <p>To ensure platform stability, performance, and threat mitigation, SecretGate integrates trusted infrastructure providers:</p>
                <ul>
                    <li><strong>Cloudflare Infrastructure:</strong> Traffic routing, SSL/TLS termination, and DDoS protection are handled via Cloudflare. Bot challenges (Cloudflare Turnstile) analyze non-identifying telemetry to block automated abuse without invading user privacy.</li>
                    <li><strong>Telegram API Services:</strong> Operational feedback submitted by users via our feedback widget is processed through secure HTTPS tunnels directly to system administrative bots. No personal tracking metadata is attached to feedback dispatches.</li>
                </ul>
            </section>

            <section class="policy-section">
                <h2>6. No Data Sharing or Monetization</h2>
                <p>We strictly maintain a <strong>No-Data-Selling Policy</strong>:</p>
                <ul>
                    <li>We do not sell, rent, lease, or trade user data to advertisers, data brokers, or third-party entities.</li>
                    <li>We do not monetize user activity through target-oriented behavioral surveillance.</li>
                </ul>
            </section>

            <section class="policy-section">
                <h2>7. Content Moderation &amp; Abuse Reporting</h2>
                <p>While SecretGate enforces privacy, we strictly prohibit hate speech, cyberbullying, harassment, extortion, and illegal activities (as specified in our Terms of Service).</p>
                <ul>
                    <li><strong>Reporting System:</strong> Recipients may report abusive or harmful messages. Reported message identifiers may be flagged to block abusive IP addresses from further system access.</li>
                    <li><strong>Zero Tolerance:</strong> IP hashes engaging in malicious attacks or severe policy violations will be permanently blacklisted at the network gateway level.</li>
                </ul>
            </section>
